...
- [x] **Phase 3: App Actions** - Common simulator dev actions from the side panel (completed 2026-08-31)
- [x] **Phase 4: Design Tools** - Visual overlays on top of the Simulator window (completed 2026-09-01)
...
- [x] 03-05-phase-gate-closure-PLAN.md — Docs update, full suite + dependency-pin gate, phase-gate manual smoke
...
- [x] 04-03-ruler-magnifier-PLAN.md — PixelSamplerService cached-capture sampling (sanctioned Task-bridge) + ruler with device-point distance readout + magnifier loupe with click-to-commit color picker via capture-mode input (criterion 2)
...
- [x] 07-05-phase6-view-wiring-PLAN.md — Tracer: StatusBarSectionView into the Actions catalog, then BuildStats/AXTree/Camera with pid threading + probeSupport gap closure; REQ-fr-13 safe (no 5th tab) (criterion 5)
