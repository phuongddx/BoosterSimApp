...
- [ ] **REQ-roadmap-phase4-design-tools**: Visual overlays — 8pt/4pt grid, safe-area insets, ruler with distance measurement, magnifier with color picker, Figma/Sketch design comparison, focus-persistent overlays, per-tool toggle persistence
...
| REQ-roadmap-phase4-design-tools | Phase 4 | Pending |
